...
#define IMX219_MEDIA_BUS_FMT		MEDIA_BUS_FMT_SRGGB10_1X10
			   ...
			   struct v4l2_subdev_format *fmt)
{
	...
	fmt->format.code = IMX219_MEDIA_BUS_FMT;
				  ...
				  struct v4l2_subdev_mbus_code_enum *code)
{
	if (code->index != 0)
		return -EINVAL;
	code->code = IMX219_MEDIA_BUS_FMT;
				    ...
				    struct v4l2_subdev_frame_size_enum *fse)
{
	...
	if (fse->code != IMX219_MEDIA_BUS_FMT)
		return -EINVAL;
...
static int imx219_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
{
	...
	try_fmt->code = IMX219_MEDIA_BUS_FMT;
...
static int imx219_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_VBLANK:
		...
		ret = imx219_write_reg(imx219->client, IMX219_REG_VTS,
				       ...
				       ctrl->val + imx219->cur_mode->height);
		break;
